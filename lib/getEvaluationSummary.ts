...
/**
 * Fetch and compute the evaluation summary directly from Supabase.
 * Use this in Server Components instead of fetching /api/evaluations/summary,
...
export async function getEvaluationSummary(): Promise<EvaluationSummary[] | null> {
  ...
  if (coursesResult.error || evaluationsResult.error) {
    return null;
  }
